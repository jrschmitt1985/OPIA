...
FONTES = {
    ...
    "aula3": "https://colab.research.google.com/drive/1NhK84WwXNiG4HQSUbKZ0pUcT5ezVX7Xx",
    "dados_sinteticos": "https://colab.research.google.com/drive/1mm2gUmYbqO4MBcEgLr2LVAKkRSTvLGRZ",
...
def calcular_atributos(limpo, cfg):
    """PHIE segue o Colab: NPHI*(1-VCL). Todos os parâmetros são hipóteses."""
    df = limpo.copy()
...
Arquivo: **{meta['arquivo']}**. Grupo: **preencher integrantes e conferir exclusividade no Moodle**.
...
Conferir disponibilidade do LAS entre grupos e preencher os integrantes antes da entrega.
...
- Dados sintéticos usados apenas como referência: {FONTES['dados_sinteticos']}
...
if __name__=="__main__":
    ...
    print("Concluído. Consulte resultados/relatorio.html e AA2_analise.ipynb.")
